...
public class XScalarEffect implements CardEffect, CardScalar, CardTooltipNester {
    ...
    public Text appendInlineTooltip(World world, List<Text> tooltip, TooltipContext tooltipContext) {
        return Text.translatable("card.battlecards.tooltip.x_scalar.inline",ratio.appendInlineTooltip(world, tooltip, tooltipContext));
    }

    public static class Serializer implements CardEffectSerializer {
        @Override
        public XScalarEffect readFromJson(Identifier id, JsonElement entry) {
            XScalarEffect output = new XScalarEffect();
