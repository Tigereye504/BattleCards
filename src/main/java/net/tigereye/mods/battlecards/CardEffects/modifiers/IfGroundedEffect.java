...
public class IfGroundedEffect implements CardEffect, CardTooltipNester {
    ...
    public static class Serializer implements CardEffectSerializer {
        @Override
        public IfGroundedEffect readFromJson(Identifier id, JsonElement entry) {
            IfGroundedEffect output = new IfGroundedEffect();
